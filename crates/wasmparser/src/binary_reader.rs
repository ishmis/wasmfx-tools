...
impl<'a> BinaryReader<'a> {
        ...
        T: VisitOperator<'a>,
    {
        ...
        Ok(match code {
            ...
            0xe6 => visitor.visit_handler_new(self.read_var_u32()?),
            0xe7 => visitor.visit_suspend_to(self.read_var_u32()?, self.read_var_u32()?),
            0xe8 => visitor.visit_resume_with(self.read_var_u32()?, self.read()?),
